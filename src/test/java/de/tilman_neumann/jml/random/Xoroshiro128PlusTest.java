...
/**
 * Tests of the Xoroshiro128Plus random number generator.
 * 
 * @author Tilman Neumann
 */
public class Xoroshiro128PlusTest {
	private static final Logger LOG = LogManager.getLogger(Xoroshiro128PlusTest.class);

	private static final int NCOUNT = 1000000;
	private static final long LOWER = 1L<<20;
	private static final long UPPER = 1L<<50;

	private static final Xoroshiro128Plus rng = new Xoroshiro128Plus();

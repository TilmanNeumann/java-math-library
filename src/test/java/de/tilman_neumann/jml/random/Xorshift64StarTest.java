...
/**
 * Tests of the Xorshift64Star random number generator.
 * 
 * @author Tilman Neumann
 */
public class Xorshift64StarTest {
	private static final Logger LOG = LogManager.getLogger(Xorshift64StarTest.class);

	private static final int NCOUNT = 1000000;
	private static final long LOWER = 1L<<20;
	private static final long UPPER = 1L<<50;

	private static final Xorshift64Star rng = new Xorshift64Star();

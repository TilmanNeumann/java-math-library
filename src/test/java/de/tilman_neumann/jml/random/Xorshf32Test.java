...
/**
 * Tests of the Xorshf32 random number generator.
 * 
 * @author Tilman Neumann
 */
public class Xorshf32Test {
	private static final Logger LOG = LogManager.getLogger(Xorshf32Test.class);

	private static final int NCOUNT = 1000000;
	private static final int LOWER = 1<<10;
	private static final int UPPER = 1<<25;
	
	private static final Xorshf32 rng = new Xorshf32();

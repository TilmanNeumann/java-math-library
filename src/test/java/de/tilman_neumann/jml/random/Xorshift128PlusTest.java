...
/**
 * Tests of the Xorshift128Plus random number generator.
 * 
 * @author Tilman Neumann
 */
public class Xorshift128PlusTest {
	private static final Logger LOG = LogManager.getLogger(Xorshift128PlusTest.class);

	private static final int NCOUNT = 1000000;
	private static final long LOWER = 1L<<20;
	private static final long UPPER = 1L<<50;

	private static final Xorshift128Plus rng = new Xorshift128Plus();

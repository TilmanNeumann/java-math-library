...
/**
 * QA tests for the PollardRhoBrentMontgomery64MHInlined factor algorithm.
 * 
 * All tests successful, but some 63 bit numbers with questionable performance.
 */
public class PollardRhoBrentMontgomery64MHInlinedTest {
	private static final Logger LOG = LogManager.getLogger(PollardRhoBrentMontgomery64MHInlinedTest.class);

	private static final boolean RUN_SLOW_TESTS_TOO = false;
	
	private static PollardRhoBrentMontgomery64MHInlined pollardRho;

	@BeforeClass
	public static void setup() {
		ConfigUtil.initProject();
		pollardRho = new PollardRhoBrentMontgomery64MHInlined();
	}

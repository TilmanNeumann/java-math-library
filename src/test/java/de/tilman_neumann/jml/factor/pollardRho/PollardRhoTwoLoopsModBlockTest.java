...
public class PollardRhoTwoLoopsModBlockTest {
	private static final Logger LOG = LogManager.getLogger(PollardRhoTwoLoopsModBlockTest.class);

	private static final PollardRhoTwoLoopsModBlock pollardRho = new PollardRhoTwoLoopsModBlock();

 ...
 */
public class PollardRhoBrentMontgomery64MHTest extends FactorTestBase {

	private static final boolean RUN_SLOW_TESTS_TOO = false;

	public PollardRhoBrentMontgomery64MHTest() {
		super(new PollardRhoBrentMontgomery64MH());
	}
	...
	public void testHarderSemiprimesWithFactorsOfDifferentSize() {
		...
		if (RUN_SLOW_TESTS_TOO) assertFullFactorizationSuccess(7836704265571283783L, "130781947 * 59921911589"); // 63 bit
		if (RUN_SLOW_TESTS_TOO) assertFullFactorizationSuccess(8940500625246794041L, "240556271 * 37165942871"); // 63 bit
		assertFullFactorizationSuccess(3608228875180849937L, "49696057 * 72605938841"); // 62 bit
		if (RUN_SLOW_TESTS_TOO) assertFullFactorizationSuccess(9170754184293724117L, "290060959 * 31616644363"); // 63 bit
	}
}

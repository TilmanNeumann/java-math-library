...
public class PollardRhoBrentMontgomeryR64Mul63Runner {
	private static final Logger LOG = LogManager.getLogger(PollardRhoBrentMontgomeryR64Mul63Runner.class);

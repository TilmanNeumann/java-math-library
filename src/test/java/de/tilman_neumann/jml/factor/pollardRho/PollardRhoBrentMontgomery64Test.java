 ...
 */
public class PollardRhoBrentMontgomery64Test {
	private static final Logger LOG = LogManager.getLogger(PollardRhoBrentMontgomery64Test.class);

	private static final boolean RUN_SLOW_TESTS_TOO = false;
	
	private static PollardRhoBrentMontgomery64 pollardRho;

	@BeforeClass
	public static void setup() {
		ConfigUtil.initProject();
		pollardRho = new PollardRhoBrentMontgomery64();
	}

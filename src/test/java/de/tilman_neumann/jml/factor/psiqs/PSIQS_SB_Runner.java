...
public class PSIQS_SB_Runner {

	private static final Logger LOG = LogManager.getLogger(PSIQS_SB_Runner.class);
	...
	public static void main(String[] args) {
		...
		PSIQS_SB qs = new PSIQS_SB(0.31F, 0.37F, null, numThreads, new NoPowerFinder(), new MatrixSolverBlockLanczos());

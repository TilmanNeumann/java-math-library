...
public class PSIQS_Runner {

	private static final Logger LOG = LogManager.getLogger(PSIQS_Runner.class);
	...
	public static void main(String[] args) {
		...
		PSIQS qs = new PSIQS(0.31F, 0.37F, null, numThreads, new NoPowerFinder(), new MatrixSolverBlockLanczos());

...
public class TDiv63InverseTest extends FactorTestBase {
	...
	public void testSomeParticularNumbers() {
		...
		assertFullFactorizationFailure(24596491225651L, "3311299 * 7428049"); // 45 bit, needs factorLimit=2^22
		...
		assertFullFactorizationFailure(293851765137859L, "11736397 * 25037647"); // 49 bit, needs factorLimit=2^24
	}

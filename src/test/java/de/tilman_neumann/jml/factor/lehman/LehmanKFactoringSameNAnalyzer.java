 ...
 */
public class LehmanKFactoringSameNAnalyzer {
	private static final Logger LOG = LogManager.getLogger(LehmanKFactoringSameNAnalyzer.class);
	...
	public static void main(String[] args) {
    	...
    	LehmanKFactoringSameNAnalyzer testEngine = new LehmanKFactoringSameNAnalyzer();

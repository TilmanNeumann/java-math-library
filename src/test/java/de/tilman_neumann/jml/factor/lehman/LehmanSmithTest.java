...
/**
 * QA tests for our port of Warren D. Smith's implementation of Lehman's factor algorithm.
 * 
 * The stability of the algorithm looks pretty good, few test errors and those only for fairly big inputs.
 */

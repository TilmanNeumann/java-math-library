...
public class LehmanSimpleTest {
	...
	private static Lehman_Simple lehman;

	@BeforeClass
	public static void setup() {
		ConfigUtil.initProject();
		lehman = new Lehman_Simple(false);
	}
	...
	public void testCompositesWithManyFactors() {
		...
		assertFactorizationError(1096954293075013905L, "3 * 5 * 7^2 * 169681 * 8795650783"); // 60 bit
	...
	public void testSemiprimesWithFactorsOfSimilarSize() {
		...
		assertFactorizationError(1253586675305333L, "6030247 * 207883139"); // 51 bit
		assertFactorizationError(1139151196120601L, "232987 * 4889333723"); // 51 bit
		assertFactorizationError(1553712951089947L, "29184373 * 53237839"); // 51 bit
		assertFactorizationError(2235885271339597L, "38826707 * 57586271"); // 51 bit
		assertFactorizationError(1586929215386303L, "4605361 * 344583023"); // 51 bit
		assertFactorizationError(930705057210221L, "25325941 * 36749081"); // 50 bit
		assertFactorizationError(1067332898136023L, "26165441 * 40791703"); // 50 bit
		assertFactorizationSuccess(8311092540494299L, "67613999 * 122919701"); // 53 bit
		assertFactorizationError(23603982383629381L, "118493549 * 199200569"); // 55 bit
		assertFactorizationError(58725827789610857L, "103129121 * 569439817"); // 56 bit
		assertFactorizationError(369313815090910177L, "354877001 * 1040681177"); // 59 bit
		assertFactorizationError(41382606407163353L, "69696377 * 593755489"); // 56 bit
		assertFactorizationError(306358296309770459L, "209066843 * 1465360513"); // 59 bit
		assertFactorizationSuccess(474315852287951L, "15390191 * 30819361"); // 49 bit
		assertFactorizationError(9400170223537253L, "47701151 * 197063803"); // 54 bit
		assertFactorizationError(35239016917581299L, "82794071 * 425622469"); // 55 bit
		assertFactorizationError(37915240075398767L, "16632857 * 2279538631"); // 56 bit
		assertFactorizationError(459926431465210403L, "631315747 * 728520449"); // 59 bit
		assertFactorizationError(752882545886305349L, "460178669 * 1636065721"); // 60 bit
		assertFactorizationSuccess(179503729521451L, "7420397 * 24190583"); // 48 bit
		assertFactorizationError(1059150637518581L, "22339673 * 47411197"); // 50 bit
		assertFactorizationError(3209190314462729L, "24571021 * 130608749"); // 52 bit
		assertFactorizationError(17586811742837503L, "105611027 * 166524389"); // 54 bit
		assertFactorizationError(13745855671622359L, "50960113 * 269737543"); // 54 bit
		assertFactorizationError(15727038894518533L, "55460939 * 283569647"); // 54 bit
		assertFactorizationError(66804960995707271L, "125296429 * 533175299"); // 56 bit
		assertFactorizationSuccess(38704493646912997L, "31501721 * 1228646957"); // 56 bit
		assertFactorizationError(56025872236672099L, "53839061 * 1040617559"); // 56 bit
		assertFactorizationError(57675022504187287L, "172307477 * 334721531"); // 56 bit
	...
	public void testSemiprimesWithFactorsOfDifferentSize() {
		...
		assertFactorizationError(338719143795073L, "1516817 * 223309169"); // 49 bit
		...
		assertFactorizationError(1773019201473077L, "6539893 * 271108289"); // 51 bit
		...
		assertFactorizationError(2986396307326613L, "27054757 * 110383409"); // 52 bit
		...
		assertFactorizationError(485069046631849L, "287537 * 1686979577"); // 49 bit
		assertFactorizationError(1239671094365611L, "5148659 * 240775529"); // 51 bit
		assertFactorizationError(2815471543494793L, "3865469 * 728364797"); // 52 bit
		assertFactorizationError(5682546780292609L, "52196827 * 108867667"); // 53 bit
	}
	...
	public void testHarderSemiprimesWithFactorsOfDifferentSize() {
		assertFactorizationError(17977882519205951L, "6026521 * 2983127831"); // 54 bit
		assertFactorizationError(57410188984551071L, "7419119 * 7738141009"); // 56 bit
	...
	private void assertFactorizationSuccess(long N, String expectedPrimeFactorizationStr) {
		...
		SortedMultiset<BigInteger> factors = lehman.factor(NBig);

...
/**
 * QA tests for the LehmanSimple factor algorithm.
 */
public class LehmanSimpleTest extends FactorTestBase {
	...
	public void testCompositesWithManyFactors() {
		...
		assertFullFactorizationFailure(1096954293075013905L, "3 * 5 * 7^2 * 169681 * 8795650783"); // 60 bit
	...
	public void testSemiprimesWithFactorsOfSimilarSize() {
		...
		assertFullFactorizationFailure(1253586675305333L, "6030247 * 207883139"); // 51 bit
		assertFullFactorizationFailure(1139151196120601L, "232987 * 4889333723"); // 51 bit
		assertFullFactorizationFailure(1553712951089947L, "29184373 * 53237839"); // 51 bit
		assertFullFactorizationFailure(2235885271339597L, "38826707 * 57586271"); // 51 bit
		assertFullFactorizationFailure(1586929215386303L, "4605361 * 344583023"); // 51 bit
		assertFullFactorizationFailure(930705057210221L, "25325941 * 36749081"); // 50 bit
		assertFullFactorizationFailure(1067332898136023L, "26165441 * 40791703"); // 50 bit
		assertFullFactorizationSuccess(8311092540494299L, "67613999 * 122919701"); // 53 bit
		assertFullFactorizationFailure(23603982383629381L, "118493549 * 199200569"); // 55 bit
		assertFullFactorizationFailure(58725827789610857L, "103129121 * 569439817"); // 56 bit
		assertFullFactorizationFailure(369313815090910177L, "354877001 * 1040681177"); // 59 bit
		assertFullFactorizationFailure(41382606407163353L, "69696377 * 593755489"); // 56 bit
		assertFullFactorizationFailure(306358296309770459L, "209066843 * 1465360513"); // 59 bit
		assertFullFactorizationSuccess(474315852287951L, "15390191 * 30819361"); // 49 bit
		assertFullFactorizationFailure(9400170223537253L, "47701151 * 197063803"); // 54 bit
		assertFullFactorizationFailure(35239016917581299L, "82794071 * 425622469"); // 55 bit
		assertFullFactorizationFailure(37915240075398767L, "16632857 * 2279538631"); // 56 bit
		assertFullFactorizationFailure(459926431465210403L, "631315747 * 728520449"); // 59 bit
		assertFullFactorizationFailure(752882545886305349L, "460178669 * 1636065721"); // 60 bit
		assertFullFactorizationSuccess(179503729521451L, "7420397 * 24190583"); // 48 bit
		assertFullFactorizationFailure(1059150637518581L, "22339673 * 47411197"); // 50 bit
		assertFullFactorizationFailure(3209190314462729L, "24571021 * 130608749"); // 52 bit
		assertFullFactorizationFailure(17586811742837503L, "105611027 * 166524389"); // 54 bit
		assertFullFactorizationFailure(13745855671622359L, "50960113 * 269737543"); // 54 bit
		assertFullFactorizationFailure(15727038894518533L, "55460939 * 283569647"); // 54 bit
		assertFullFactorizationFailure(66804960995707271L, "125296429 * 533175299"); // 56 bit
		assertFullFactorizationSuccess(38704493646912997L, "31501721 * 1228646957"); // 56 bit
		assertFullFactorizationFailure(56025872236672099L, "53839061 * 1040617559"); // 56 bit
		assertFullFactorizationFailure(57675022504187287L, "172307477 * 334721531"); // 56 bit
		assertFullFactorizationFailure(69916262762899909L, "72133751 * 969258659"); // 56 bit
		assertFullFactorizationFailure(51113648728234999L, "49275467 * 1037304197"); // 56 bit
		assertFullFactorizationFailure(55878279398722441L, "131149259 * 426066299"); // 56 bit
	...
	public void testSemiprimesWithFactorsOfDifferentSize() {
		...
		assertFullFactorizationFailure(338719143795073L, "1516817 * 223309169"); // 49 bit
		...
		assertFullFactorizationFailure(1773019201473077L, "6539893 * 271108289"); // 51 bit
		...
		assertFullFactorizationFailure(2986396307326613L, "27054757 * 110383409"); // 52 bit
		...
		assertFullFactorizationFailure(485069046631849L, "287537 * 1686979577"); // 49 bit
		assertFullFactorizationFailure(1239671094365611L, "5148659 * 240775529"); // 51 bit
		assertFullFactorizationFailure(2815471543494793L, "3865469 * 728364797"); // 52 bit
		assertFullFactorizationFailure(5682546780292609L, "52196827 * 108867667"); // 53 bit
	}
	...
	public void testHarderSemiprimesWithFactorsOfSimilarSize() {
		...
		assertFullFactorizationFailure(3225273260887418687L, "567914891 * 5679148957"); // 62 bit
	}
	
	@Test
	public void testHarderSemiprimesWithFactorsOfDifferentSize() {
		assertFullFactorizationFailure(17977882519205951L, "6026521 * 2983127831"); // 54 bit
		assertFullFactorizationFailure(57410188984551071L, "7419119 * 7738141009"); // 56 bit
		assertFullFactorizationFailure(708198179721093877L, "31472003 * 22502481959"); // 60 bit
		assertFullFactorizationFailure(4085731848127832849L, "825205747 * 4951167467"); // 62 bit
		
		assertFullFactorizationFailure(873351084013120721L, "29133103 * 29977963007"); // 60 bit
		assertFullFactorizationFailure(7355428158429213199L, "6226303 * 1181347608433"); // 63 bit
		assertFullFactorizationFailure(7836704265571283783L, "130781947 * 59921911589"); // 63 bit
		assertFullFactorizationFailure(8940500625246794041L, "240556271 * 37165942871"); // 63 bit
		assertFullFactorizationFailure(3608228875180849937L, "49696057 * 72605938841"); // 62 bit
		assertFullFactorizationFailure(9170754184293724117L, "290060959 * 31616644363"); // 63 bit
	}
}

 ...
 */
public class LehmanFastTest {
	private static final Logger LOG = LogManager.getLogger(LehmanFastTest.class);

	private static Lehman_Fast lehman;

	@BeforeClass
	public static void setup() {
		ConfigUtil.initProject();
		lehman = new Lehman_Fast(false);
	}
	...
	public void testHarderSemiprimesWithFactorsOfDifferentSize() {
		...
		assertFactorizationError(4085731848127832849L, "825205747 * 4951167467"); // 62 bit, does not even work with I_MAX=2^25
		...
		assertFactorizationError(8940500625246794041L, "240556271 * 37165942871"); // 63 bit, does not even work with I_MAX=2^25

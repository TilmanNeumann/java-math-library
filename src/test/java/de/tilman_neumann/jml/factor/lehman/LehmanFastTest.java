...
/**
 * QA tests for the LehmanFast factor algorithm.
 */
public class LehmanFastTest extends FactorTestBase {

	public LehmanFastTest() {
		super(new LehmanFast(false));
	}
	...
	public void testHarderSemiprimesWithFactorsOfDifferentSize() {
		...
		assertFullFactorizationFailure(4085731848127832849L, "825205747 * 4951167467"); // 62 bit, does not even work with I_MAX=2^25
		...
		assertFullFactorizationFailure(8940500625246794041L, "240556271 * 37165942871"); // 63 bit, does not even work with I_MAX=2^25

...
public class CFracTest extends FactorTestBase {
	...
	public void testLowEndSemiprimes() {
		List<BigInteger> fails = testFindSingleFactorForSemiprimes(BigInteger.valueOf(1<<24), BigInteger.valueOf((1<<24) + 10000));
	...
	public void testSomeInputs() {
		...
		assertFullFactorizationFailure("5679148659138759837165981543", "3^3 * 466932157 * 450469808245315337"); // an example that CFrac may fail when there are >= 2 small factors
		// takes too long for CFrac

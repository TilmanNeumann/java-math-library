 ...
 * With ks_adjust==3 as used here it will work for N>=19 bit.
 * 
 ...
 */
public class CFrac63Test {
	private static final Logger LOG = LogManager.getLogger(CFrac63Test.class);

	private static final CFrac63 cFrac = new CFrac63(true, 5, 1.5F, 0.152F, 0.25F, new TDiv_CF63_01(), new MatrixSolverGauss02(), 3);
	...
	public void testLowEndSemiprimes() {
		List<BigInteger> fails = FactorTestInfrastructure.testSemiprimes(BigInteger.valueOf(1<<19), BigInteger.valueOf((1<<19) + 10000), cFrac);
	...
	private void assertFactorizationError(long N, String expectedPrimeFactorizationStr) {
		...
		SortedMultiset<BigInteger> factors = cFrac.factor(NBig);
		LOG.info(N + " = " + factors.toString("*", "^"));

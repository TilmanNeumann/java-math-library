 ...
 */
public class HartFast2MultFMATest {
	private static final Logger LOG = LogManager.getLogger(HartFast2MultFMATest.class);

	private static final HartFast2MultFMA hart = new HartFast2MultFMA(false);
	...
	public void testHarderSemiprimesWithFactorsOfSimilarSize() {
		...
		assertFactorizationError(3225273260887418687L, "567914891 * 5679148957"); // 62 bit, needs I_MAX=2^23
	}

 ...
 */
public class HartTDivRaceTest {
	private static final Logger LOG = LogManager.getLogger(HartTDivRaceTest.class);

	private static final HartTDivRace hart = new HartTDivRace();
	...
	public void testHarderSemiprimesWithFactorsOfSimilarSize() {
		...
		assertFactorizationError(3225273260887418687L, "567914891 * 5679148957"); // 62 bit, needs I_MAX=2^25
	}
	...
	public void testHarderSemiprimesWithFactorsOfDifferentSize() {
		...
		assertFactorizationError(3608228875180849937L, "49696057 * 72605938841"); // 62 bit, needs I_MAX=2^22
		assertFactorizationError(9170754184293724117L, "290060959 * 31616644363"); // 63 bit, needs I_MAX=2^24
	}

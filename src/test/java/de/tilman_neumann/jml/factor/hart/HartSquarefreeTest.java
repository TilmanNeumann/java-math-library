...
public class HartSquarefreeTest {
	...
	private static final HartSquarefree hart = new HartSquarefree(false);
	...
	public void testHarderSemiprimesWithFactorsOfDifferentSize() {
		...
		assertFactorizationError(708198179721093877L, "31472003 * 22502481959"); // 60 bit, needs I_MAX=2^22
		assertFactorizationSuccess(4085731848127832849L, "825205747 * 4951167467"); // 62 bit
		
		assertFactorizationError(873351084013120721L, "29133103 * 29977963007"); // 60 bit, needs I_MAX=2^25

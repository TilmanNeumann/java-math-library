 ...
 */
public class HartFast2Mult2Test {
	private static final Logger LOG = LogManager.getLogger(HartFast2Mult2Test.class);

	private static final HartFast2Mult2 hart = new HartFast2Mult2(false);

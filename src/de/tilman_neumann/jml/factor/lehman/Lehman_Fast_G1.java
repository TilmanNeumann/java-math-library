...
/**
 * Testing an idea of Graeme Willoughby.
 * 
 * @authors Graeme Willoughby + Tilman Neumann
 */
public class Lehman_Fast_G1 extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Lehman_Fast_G1.class);
	 ...
	 */
	public Lehman_Fast_G1(boolean doTDivFirst) {
	...
	public String getName() {
		return "Lehman_Fast_G1(" + doTDivFirst + ")";
	}
...
//			}
			...
			int step=64;
			int icount=0;
			while (( icount<64) & (a<aLimit) ) {
				long b2_64 = (a*a -fourkN)&63;
				if ( ((0x202021202030213L>>b2_64)&1) == 1) {
					long  a_64=a;
					while (a_64< aLimit) {
						long b2 = (a_64*a_64 - fourkN);
						final long b = (long) Math.sqrt(b2);
						if (b*b == b2) {
//						if (issquare(b2) ) {         // replace these lines with your own way of checking if b is a square
//							long b=isqrt(b2);
//							return  a_64+b;  // or gcd(a_64+b, N) as appropriate
							return  gcdEngine.gcd(a_64+b, N);
						}
						a_64+=step;
					}
				}
	...
	public static void main(String[] args) {
		...
		Lehman_Fast_G1 lehman = new Lehman_Fast_G1(true);

 ...
 */
public class Lehman_Fast4 extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Lehman_Fast4.class);
	 ...
	 */
	public Lehman_Fast4(boolean doTDivFirst) {
	...
	public String getName() {
		return "Lehman_Fast4(" + doTDivFirst + ")";
	}
	...
	public static void main(String[] args) {
		...
		Lehman_Fast4 lehman = new Lehman_Fast4(false);

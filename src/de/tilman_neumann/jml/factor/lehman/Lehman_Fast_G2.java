 ...
 */
public class Lehman_Fast_G2 extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Lehman_Fast_G2.class);
	 ...
	 */
	public Lehman_Fast_G2(boolean doTDivFirst) {
	...
	public String getName() {
		return "Lehman_Fast_G2(" + doTDivFirst + ")";
	}
...
//							return  a_64+b;  // or gcd(a_64+b, N) as appropriate
	...
	public static void main(String[] args) {
		...
		Lehman_Fast_G2 lehman = new Lehman_Fast_G2(true);

 ...
 */
public class Lehman_Fast3 extends FactorAlgorithm {
	 ...
	 */
	public Lehman_Fast3(boolean doTDivFirst) {
	...
	public String getName() {
		return "Lehman_Fast3(" + doTDivFirst + ")";
	}
	...
	public static void main(String[] args) {
		...
		Lehman_Fast3 lehman = new Lehman_Fast3(false);

 ...
 */
public class Lehman_Analyzer1_0 {
	private static final Logger LOG = Logger.getLogger(Lehman_Analyzer1_0.class);
	...
	public static void main(String[] args) {
		...
		while (true) {
	    	...
	    	Lehman_Analyzer1_0 testEngine = new Lehman_Analyzer1_0();

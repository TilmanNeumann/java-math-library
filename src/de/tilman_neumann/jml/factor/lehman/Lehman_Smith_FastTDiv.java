 ...
 * 
 * TODO: Fails for a few N >= 45 bit where Lehman_Smith doesn't fail.
 * 
 * @author Tilman Neumann
 */
public class Lehman_Smith_FastTDiv extends FactorAlgorithmBase {
	private static final Logger LOG = Logger.getLogger(Lehman_Smith_FastTDiv.class);
	 ...
	 */
	public Lehman_Smith_FastTDiv(boolean doTDivFirst) {
		this.doTDivFirst = doTDivFirst;
	}

	@Override
	public String getName() {
		return "Lehman_Smith_FastTDiv(" + doTDivFirst + ")";
	}
	...
	public static void main(String[] args) {
		...
		Lehman_Smith_FastTDiv lehman = new Lehman_Smith_FastTDiv(true);

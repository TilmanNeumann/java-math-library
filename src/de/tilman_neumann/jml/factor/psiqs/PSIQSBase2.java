...
import de.tilman_neumann.jml.factor.siqs.sieve.SieveParamsFactory03;
...
abstract public class PSIQSBase2 extends FactorAlgorithm {
	...
	private BigInteger findSingleFactorInternal(BigInteger N) {
		...
		SieveParams sieveParams = SieveParamsFactory03.create(N_dbl, NBits, kN, d, primesArray, primeBaseSize, adjustedSieveArraySize, apg.getQCount(), apg.getBestQ());

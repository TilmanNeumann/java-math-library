...
abstract public class PSIQSBase2 extends FactorAlgorithm {
	...
	public BigInteger findSingleFactor(BigInteger N) {
		...
		PSIQSThreadBase2[] threadArray = new PSIQSThreadBase2[numberOfThreads];
	...
	abstract protected PSIQSThreadBase2 createThread(
	...
	private void killThread(PSIQSThreadBase2 t) {
    	while (t.isAlive()) {

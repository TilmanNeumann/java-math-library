 ...
 */
public class PSIQS_g extends PSIQSBase {
	 ...
	 */
	public PSIQS_g(float Cmult, float Mmult, Integer wantedQCount, int numberOfThreads, PowerFinder powerFinder, MatrixSolver matrixSolver) {
		super(Cmult, Mmult, numberOfThreads, null, powerFinder, matrixSolver, new AParamGenerator01(wantedQCount));
	}

	@Override
	public String getName() {
		return "PSIQS_g(Cmult=" + Cmult + ", Mmult=" + Mmult + ", qCount=" + apg.getQCount() + ", " + powerFinder.getName() + ", " + matrixSolver.getName() + ", " + numberOfThreads + " threads)";
	}
	...
	protected PSIQSThreadBase createThread(
		...
		return new PSIQSThread_g(k, N, kN, d, sieveParams, baseArrays, apg, cc, threadIndex);
	}
}

 ...
 */
public class PSIQS2 extends PSIQSBase2 {
	 ...
	 */
	public PSIQS2(float Cmult, float Mmult, Integer wantedQCount, Float maxQRestExponent,
	...
	public String getName() {
		...
		return "PSIQS2(Cmult=" + Cmult + ", Mmult=" + Mmult + ", qCount=" + apg.getQCount() + ", " + maxQRestExponentStr + ", " + powerFinder.getName() + ", " + matrixSolver.getName() + ", " + numberOfThreads + " threads)";
	}

	@Override
	protected PSIQSThreadBase2 createThread(
		...
		return new PSIQSThread2(k, N, kN, d, sieveParams, baseArrays, apg, cc, threadIndex);
	}
}

 ...
 */
public class SIQS2 extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(SIQS2.class);
	...
	public String getName() {
		return "SIQS2(Cmult=" + Cmult + ", Mmult=" + Mmult + ", qCount=" + apg.getQCount()+ ", " + powerFinder.getName() + ", " + polyGenerator.getName() + ", " + sieve.getName() + ", " + auxFactorizer.getName() + ", " + matrixSolver.getName() + ")";
	}
	...
	public static void main(String[] args) {
		...
		SIQS2 qs = new SIQS2(0.32F, 0.37F, null, new NoPowerFinder(), new SIQSPolyGenerator(), new Sieve03gU(), new TDiv_QS_nLarge_UBI(true), 10, new MatrixSolver_BlockLanczos());

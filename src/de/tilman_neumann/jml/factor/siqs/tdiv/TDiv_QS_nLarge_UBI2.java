...
public class TDiv_QS_nLarge_UBI2 implements TDiv_QS {
	private static final Logger LOG = Logger.getLogger(TDiv_QS_nLarge_UBI2.class);
	 ...
	 */
	public TDiv_QS_nLarge_UBI2(boolean permitUnsafeUsage) {

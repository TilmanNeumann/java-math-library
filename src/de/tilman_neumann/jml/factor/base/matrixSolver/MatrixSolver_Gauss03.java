...
/**
 * Best single-threaded Gaussian solver for N > 250 bit.
 * 
 * The main improvement came from adopting the new base class due to Dave McGuigan.
 * Another push for large N was a selection of pivot rows leading to sparser matrices during the solution procedure;
 * this required to take explicit control of the biggest column indices of all rows.
 * 
 * @author Tilman Neumann
 */
public class MatrixSolver_Gauss03 extends MatrixSolverBase02 {

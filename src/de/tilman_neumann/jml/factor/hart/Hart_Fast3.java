 ...
 */
public class Hart_Fast3 extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Hart_Fast3.class);
	...
	static {
		...
		System.out.println("Hart_Fast3: Initialized sqrt array with " + iMax + " entries");
	}
	 ...
	 */
	public Hart_Fast3(boolean doTDivFirst) {
		this.doTDivFirst = doTDivFirst;
	}
	
	@Override
	public String getName() {
		return "Hart_Fast3(" + doTDivFirst + ")";
	}
	...
	public static void main(String[] args) {
		...
		Hart_Fast3 holf = new Hart_Fast3(false);

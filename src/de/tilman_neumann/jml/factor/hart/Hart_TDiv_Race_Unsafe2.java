 ...
 */
public class Hart_TDiv_Race_Unsafe2 extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Hart_TDiv_Race_Unsafe2.class);
	...
	public static void main(String[] args) {
		...
		Hart_TDiv_Race_Unsafe2 holf = new Hart_TDiv_Race_Unsafe2();

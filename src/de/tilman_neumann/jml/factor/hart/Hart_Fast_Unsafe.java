 ...
 * Hart_Fast is quite competitive for hard semiprimes.
 * 
 * @authors Thilo Harich & Tilman Neumann
 */
public class Hart_Fast_Unsafe extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Hart_Fast_Unsafe.class);
	 ...
	 */
	public Hart_Fast_Unsafe(boolean doTDivFirst) {
	...
	public String getName() {
		return "Hart_Fast_Unsafe(" + doTDivFirst + ")";
	}
	...
	public long findSingleFactor(long N) {
		...
		try {
			for (int i=1; ;) {
				...
				if (b*b == test) return gcdEngine.gcd(a+b, N);
				k += K_MULT;
	...
	public static void main(String[] args) {
		...
		Hart_Fast_Unsafe holf = new Hart_Fast_Unsafe(false);

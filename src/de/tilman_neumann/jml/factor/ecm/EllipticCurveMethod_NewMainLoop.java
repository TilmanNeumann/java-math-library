 ...
 * </p>
 */
public class EllipticCurveMethod_NewMainLoop extends FactorAlgorithmBase {
	private static final Logger LOG = Logger.getLogger(EllipticCurveMethod_NewMainLoop.class);
...
//				new BigInteger("1593332576170570774181606244493046197050984933692181475920784855223341")
				...
				new BigInteger("1143875372120346850604851592131"),
				new BigInteger("195474336941943541078338926949197"),
				new BigInteger("362639025392631003524849486747436853"),
				new BigInteger("537469860046113963500106746462079631981"),
				new BigInteger("622157829311274487677773721588686057513"),
				new BigInteger("781947916704865929893013529008915126184412912681"),
				new BigInteger("624521213440662081513495888873734147263544077656097"),
				new BigInteger("790315674312731110109150789595790345964862668938533229"),
				new BigInteger("521313855307059716602808060509109943338823203594823839317"),
				new BigInteger("469347138766520352466194960704366858408811776149656408709757"),
				new BigInteger("915956322053823263321911089988620366440623361266369640334359399"),
		};
		
		EllipticCurveMethod_NewMainLoop ecm = new EllipticCurveMethod_NewMainLoop();

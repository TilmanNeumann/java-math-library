 ...
 *
 * <p>This variant has been stripped off trial division, so it is recommended to do some trial division before
 * calling it. The original implementation did trial division for all p < 131072.</p>
 * 
 * <p>See <a href="https://en.wikipedia.org/wiki/Lenstra_elliptic_curve_factorization">
 * Wikipedia: Lenstra elliptic curve factorization</a></p>
 */
public class EllipticCurveMethod_NoTDiv extends FactorAlgorithmBase {
	private static final Logger LOG = Logger.getLogger(EllipticCurveMethod_NoTDiv.class);
	...
	public static void main(String[] args) {
		...
		EllipticCurveMethod_NoTDiv ecm = new EllipticCurveMethod_NoTDiv();

 ...
 */
public class TDiv63Inverse_NoDoubleCheck_Unroll extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(TDiv63Inverse_NoDoubleCheck_Unroll.class);
	 ...
	 * @param factorLimit
	 */
	public TDiv63Inverse_NoDoubleCheck_Unroll(int factorLimit) {
	...
	public String getName() {
		return "TDiv63Inverse_NoDoubleCheck_Unroll";
	}
	...
	public static void main(String[] args) {
		...
		// test special cases
		TDiv63Inverse_NoDoubleCheck_Unroll tdivInv = new TDiv63Inverse_NoDoubleCheck_Unroll(1<<21);

...
import de.tilman_neumann.math.factor.base.PrimeBaseGenerator;
import de.tilman_neumann.math.factor.base.congruence.AQPair;
import de.tilman_neumann.math.factor.base.congruence.CongruenceCollector;
import de.tilman_neumann.math.factor.base.congruence.CongruenceCollectorReport;
import de.tilman_neumann.math.factor.base.congruence.Partial;
import de.tilman_neumann.math.factor.base.congruence.Smooth;
import de.tilman_neumann.math.factor.base.matrixSolver.FactorTest;
import de.tilman_neumann.math.factor.base.matrixSolver.FactorTest01;
import de.tilman_neumann.math.factor.base.matrixSolver.MatrixSolver;
import de.tilman_neumann.math.factor.base.matrixSolver.MatrixSolver02_BlockLanczos;
import de.tilman_neumann.math.factor.base.matrixSolver.SmoothSolverController;
import de.tilman_neumann.math.factor.siqs.data.BaseArrays;
import de.tilman_neumann.math.factor.siqs.poly.AParamGenerator;
import de.tilman_neumann.math.factor.siqs.poly.AParamGenerator01;
import de.tilman_neumann.math.factor.siqs.poly.PolyReport;
import de.tilman_neumann.math.factor.siqs.poly.PolyGenerator;
import de.tilman_neumann.math.factor.siqs.poly.SIQSPolyGenerator;
import de.tilman_neumann.math.factor.siqs.powers.NoPowerFinder;
import de.tilman_neumann.math.factor.siqs.powers.PowerFinder;
import de.tilman_neumann.math.factor.siqs.sieve.Sieve;
import de.tilman_neumann.math.factor.siqs.sieve.Sieve03gU;
...
public class SIQS extends FactorAlgorithmBase {
	...
	public BigInteger findSingleFactor(BigInteger N) {
		...
		if (k>1) {
			...
			if (N.mod(kBig).equals(ZERO)) return kBig;
			kN = kBig.multiply(N);
		}
		...
		try {
			...
			if (profile) {
				...
				LOG.info("    multiplier k = " + k + ", kN%8 = " + kN.mod(EIGHT) + ", primeBaseSize = " + primeBaseSize + ", pMax = " + pMax + " (" + pMaxBits + " bits), sieveArraySize = " + adjustedSieveArraySize);

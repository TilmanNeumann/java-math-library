...
public class Hart_Fast2Mult2 extends FactorAlgorithm {
	private static final Logger LOG = LogManager.getLogger(Hart_Fast2Mult2.class);
	...
	public long findSingleFactor(long N) {
		...
		try {
			...
			if (DEBUG) LOG.error("Hart_Fast2Mult2: Failed to factor N=" + N + ". Either it has factors < cbrt(N) needing trial division, or the arrays are too small.");
			return 1;
		}
	}

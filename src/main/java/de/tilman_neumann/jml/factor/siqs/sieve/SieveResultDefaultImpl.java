 ...
 */
public class SieveResultDefaultImpl implements SieveResult {
	...
	public SieveResultDefaultImpl(int initalCapacity) {
	...
	public String toString() {
		return Arrays.toString(Arrays.copyOfRange(smoothCandidates, 0, usedSize));
	}
}

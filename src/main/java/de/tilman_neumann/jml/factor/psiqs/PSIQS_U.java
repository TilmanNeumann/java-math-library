...
public class PSIQS_U extends PSIQSBase {
	...
	private static final Logger LOG = LogManager.getLogger(PSIQS_U.class);
	...
	public String getName() {
		return "PSIQS_U(Cmult=" + Cmult + ", Mmult=" + Mmult + ", qCount=" + apg.getQCount() + ", " + powerFinder.getName() + ", " + matrixSolver.getName() + ", " + numberOfThreads + " threads)";
	}
	...
	public static void main(String[] args) {
		...
		PSIQS_U qs = new PSIQS_U(0.31F, 0.37F, null, numThreads, new NoPowerFinder(), new MatrixSolver_BlockLanczos());
